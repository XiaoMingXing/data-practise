...
public class PhoneNumber extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 222769428113994619L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PhoneNumber\",\"namespace\":\"com.avro.clickstreams\",\"fields\":[{\"name\":\"areaCode\",\"type\":\"string\"},{\"name\":\"countryCode\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"prefix\",\"type\":\"string\"},{\"name\":\"number\",\"type\":\"string\"}]}");
   ...
   */
  public static com.avro.clickstreams.PhoneNumber.Builder newBuilder() {
    return new com.avro.clickstreams.PhoneNumber.Builder();
  }
   ...
   * @return A new PhoneNumber RecordBuilder
   */
  public static com.avro.clickstreams.PhoneNumber.Builder newBuilder(com.avro.clickstreams.PhoneNumber.Builder other) {
    return new com.avro.clickstreams.PhoneNumber.Builder(other);
  }
   ...
   * @return A new PhoneNumber RecordBuilder
   */
  public static com.avro.clickstreams.PhoneNumber.Builder newBuilder(com.avro.clickstreams.PhoneNumber other) {
    return new com.avro.clickstreams.PhoneNumber.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneNumber>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.avro.clickstreams.PhoneNumber.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.avro.clickstreams.PhoneNumber other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.areaCode)) {
        this.areaCode = data().deepCopy(fields()[0].schema(), other.areaCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.PhoneNumber.Builder setAreaCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.PhoneNumber.Builder clearAreaCode() {
      areaCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.PhoneNumber.Builder setCountryCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.PhoneNumber.Builder clearCountryCode() {
      countryCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.PhoneNumber.Builder setPrefix(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.PhoneNumber.Builder clearPrefix() {
      prefix = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.PhoneNumber.Builder setNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.PhoneNumber.Builder clearNumber() {
      number = null;
