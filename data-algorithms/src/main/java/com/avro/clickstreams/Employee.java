...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.avro.clickstreams.PhoneNumber phoneNumber;
  @Deprecated public com.avro.clickstreams.Status status;
   ...
   */
  public Employee(java.lang.CharSequence firstName, java.lang.CharSequence nickName, java.lang.CharSequence lastName, java.lang.Integer age, java.util.List<java.lang.CharSequence> emails, com.avro.clickstreams.PhoneNumber phoneNumber, com.avro.clickstreams.Status status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: phoneNumber = (com.avro.clickstreams.PhoneNumber)value$; break;
    case 6: status = (com.avro.clickstreams.Status)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.avro.clickstreams.PhoneNumber getPhoneNumber() {
    return phoneNumber;
  }
   ...
   * @param value the value to set.
   */
  public void setPhoneNumber(com.avro.clickstreams.PhoneNumber value) {
   ...
   */
  public com.avro.clickstreams.Status getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(com.avro.clickstreams.Status value) {
    this.status = value;
  }
   ...
   */
  public static com.avro.clickstreams.Employee.Builder newBuilder() {
    return new com.avro.clickstreams.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.avro.clickstreams.Employee.Builder newBuilder(com.avro.clickstreams.Employee.Builder other) {
    return new com.avro.clickstreams.Employee.Builder(other);
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.avro.clickstreams.Employee.Builder newBuilder(com.avro.clickstreams.Employee other) {
    return new com.avro.clickstreams.Employee.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
    ...
    private com.avro.clickstreams.PhoneNumber phoneNumber;
    private com.avro.clickstreams.PhoneNumber.Builder phoneNumberBuilder;
    private com.avro.clickstreams.Status status;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.avro.clickstreams.Employee.Builder other) {
      super(other);
      ...
      if (other.hasPhoneNumberBuilder()) {
        this.phoneNumberBuilder = com.avro.clickstreams.PhoneNumber.newBuilder(other.getPhoneNumberBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.avro.clickstreams.Employee other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder setNickName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder clearNickName() {
      nickName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder setEmails(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder clearEmails() {
      emails = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder setPhoneNumber(com.avro.clickstreams.PhoneNumber value) {
     ...
     * @return This builder.
     */
    public com.avro.clickstreams.PhoneNumber.Builder getPhoneNumberBuilder() {
      if (phoneNumberBuilder == null) {
        if (hasPhoneNumber()) {
          setPhoneNumberBuilder(com.avro.clickstreams.PhoneNumber.newBuilder(phoneNumber));
        } else {
          setPhoneNumberBuilder(com.avro.clickstreams.PhoneNumber.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.avro.clickstreams.Employee.Builder setPhoneNumberBuilder(com.avro.clickstreams.PhoneNumber.Builder value) {
      clearPhoneNumber();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder clearPhoneNumber() {
      phoneNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder setStatus(com.avro.clickstreams.Status value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.avro.clickstreams.Employee.Builder clearStatus() {
      status = null;
    ...
    public Employee build() {
      try {
        ...
        if (phoneNumberBuilder != null) {
          ...
          record.phoneNumber = fieldSetFlags()[5] ? this.phoneNumber : (com.avro.clickstreams.PhoneNumber) defaultValue(fields()[5]);
        }
        record.status = fieldSetFlags()[6] ? this.status : (com.avro.clickstreams.Status) defaultValue(fields()[6]);
        return record;
